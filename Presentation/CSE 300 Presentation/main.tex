...
\begin{columns}
\column{0.5\textwidth}
\textcolor{red}{Q: \quad E Q L L K A L E F K L \\
P: \quad K V L E F G Y}
...
% \draw [color=cqcqcq,, xstep=1000cm,ystep=1000cm] (-4093.139044765442,-2195.3204666080196) grid (17040.69380844236,8358.7564503645);
% \clip(-4093.139044765442,-2195.3204666080196) rectangle (17040.69380844236,8358.7564503645);
% \draw[line width=2pt,color=ffqqqq,smooth,samples=100,domain=1105.6015098677565:2876.2475301510785] plot(\x,{freehand((\x))});
% \draw[line width=2pt,color=qqccqq,smooth,samples=100,domain=2802.4706126392734:5107.999284883183] plot(\x,{freehand((\x))});
% \draw[line width=2pt,color=yqqqyq,smooth,samples=100,domain=4960.445449859572:7450.4164158829935] plot(\x,{freehand((\x))});
% \draw [color=ffqqqq](2056.986068652867,5816.5335433565215) node[anchor=north west] {score = -10};
% \draw [color=qqzzqq](3880.1964363050583,3351.3476941366625) node[anchor=north west] {score = 50};
% \draw [color=yqqqyq](6948.839238198536,1977.5201635818455) node[anchor=north west] {score = -5};
% \draw (2403.6528286994103,732.0877293405626) node[anchor=north west] {total score = 35};
% \begin{scriptsize}
% \draw [fill=black] (2765.5821538833707,4217.548603480122) circle (2.5pt);
% \draw[color=black] (2865.875175428135,4487.644296511441) node {$A$};
% \draw [fill=black] (5000,2109.840235511369) circle (2.5pt);
% \draw[color=black] (5099.949851283637,2381.9647169694786) node {$B$};
% \draw [fill=black] (1105.6015098677565,5884.906939246916) circle (2.5pt);
% \draw[color=black] (1209.578432983538,6156.780548587388) node {$C$};
% \draw [fill=black] (7450.4164158829935,572.9688783969527) circle (2.5pt);
% \draw[color=black] (7552.296190872149,854.0630708384203) node {$D$};
% \end{scriptsize}
% \end{tikzpicture} 
% \end{frame}
